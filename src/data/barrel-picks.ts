...
export const barrelPicks: BarrelPick[] = [
  {
    ...
    stores: [
      ...
      { name: "Creekville Spirits", logoImage: "/assets/logos/Creekville-Spirits-Logo.avif" },
      { name: "Micky Finn's – Buc-ee's" },
      { name: "Mix & More", location: "N. Charleston & Mt. Pleasant" },
      { name: "Premier Spirits & More", location: "Camden & Manning", logoImage: "/assets/logos/Premier-Spirits-More-logo.png" },
      { name: "Seven Star Liquors", logoImage: "/assets/logos/7-STAR-Logo.avif" },
      { name: "Wine & Bourbon Barn", location: "Greenville, Mauldin & Simpsonville", logoImage: "/assets/logos/wine-bourbon-barn.webp" },
    ],
  ...
  },
  {
    ...
    title: "Broad Branch Distillery — Rye Fidelity",
    ...
    stores: [
      ...
      { name: "Micky Finn's – Buc-ee's" },
      { name: "Mix & More" },
      { name: "Wine & Bourbon Barn", logoImage: "/assets/logos/wine-bourbon-barn.webp" },
    ],
