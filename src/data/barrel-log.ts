...
export const collabPickLogEntries: BarrelLogEntry[] = [
  {
    ...
    partner: "South Carolina Bourbon Community",
    logoDomain: "hollowcreekdistillery.com",
    pickDate: "2023-09",
    releaseDate: "2023-10",
    bottleCount: 203,
    proof: "124.6 proof",
  ...
  },
  {
    ...
    category: "collab",
    distillery: "Hollow Creek Distillery",
    partner: "Whiskey & Whitetails Podcast / The Big Red Barn",
    logoDomain: "hollowcreekdistillery.com",
    pickDate: "2023-10",
    releaseDate: "2023-11",
    bottleCount: 202,
    proof: "126.4 proof",
    notes: "William Alan label — Battlefield Bourbon. Non-profit collab with The Big Red Barn.",
  },
  {
    id: "hollow-creek-rackhouse-cm-2023",
    category: "collab",
    distillery: "Hollow Creek Distillery",
    partner: "Rackhouse 76 & C&M Beverages",
    logoDomain: "hollowcreekdistillery.com",
    pickDate: "2025-05",
    releaseDate: "2025-06",
...
export const clientProjectEntries: ClientProjectEntry[] = [
  ...
  },
  {
    ...
    client: "Micky Finn's",
    collectionName: "7 Year OZ Tyler",
    distillery: "OZ Tyler",
    type: "Store",
